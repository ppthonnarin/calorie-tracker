...
- **บันทึกอาหาร** — ค้นจากฐานข้อมูลอาหารไทย ~107 เมนู 9 หมวด (อาหารเช้า/ข้าว-เส้น/โปรตีน/กับข้าว/ฟาสต์ฟู้ด/ผลไม้/เครื่องดื่ม/ขนม) หรือเพิ่มเอง ระบุจำนวนหน่วยได้
  - ค่าแคลอรี่ปรับให้อิงแหล่งไทย (กรมอนามัย/สำนักโภชนาการ ผ่านตารางที่เผยแพร่) — ยังเป็นค่าโดยประมาณ ±10-30% เพราะอาหารจานเดียวแปรผันตามร้าน
- **เมนูของฉัน** — เพิ่ม/แก้/ลบเมนูเอง (kcal + P/C/F + หมวด) เก็บถาวร ขึ้นบนสุดในช่องค้นหาพร้อม ⭐ ใช้ปรับให้ตรงร้านที่กินประจำ
